L.Control.Weather = L.Control.extend({
  ...
  refresh: function(callback) {
    // https://api.openweathermap.org/data/2.5/weather?q=London,UK&appid=410ad0144d353df20bf11302e29b5b0e
    var _this = this,
      center = this._map.getCenter(),

    url = "http://api.openweathermap.org/data/2.5/weather?lat=:lat&lon=:lng&type=hour&units=:units&appid=410ad0144d353df20bf11302e29b5b0e";
